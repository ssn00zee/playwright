...
test.describe('Main content test', () => {
  test('Should cotain a heading welcome to my home page', async ({page}) => {
    await page.goto(homePage)
...
test.describe('Linkning to another page', () => {
  ...
  test('should contain link to grades page', async ({page}) => {
    await page.goto(homePage)
...
test.describe('Footer tests', () => {
  test('Should contain a footer on the homepage', async ({page}) => {
    await page.goto(homePage)
...
test.describe('Check about page navigates to home page', () => {
  test('Should navigate to the homepage from the about page', async ({page}) => {
